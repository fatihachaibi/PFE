# -*- encoding: utf-8 -*-
# stub: logstash-input-http_poller 5.3.1 ruby lib
...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    ...
    s.add_runtime_dependency(%q<logstash-mixin-http_client>.freeze, [">= 7.2.0"])
    ...
    s.add_dependency(%q<logstash-mixin-http_client>.freeze, [">= 7.2.0"])
