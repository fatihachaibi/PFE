...
const CustomizablePalette = ({
  ...
  activePalette,
  setPalette,
  dataBounds = (0, _palettes.getFallbackDataBounds)((() => {
    var _activePalette$params;

    return (_activePalette$params = activePalette.params) === null || _activePalette$params === void 0 ? void 0 : _activePalette$params.rangeType;
  })()),
  showExtraActions = true,
  showRangeTypeSelector = true,
  disableSwitchingContinuity = false
}) => {
  var _activePalette$params2, _localState$activePal, _localState$activePal2, _localState$activePal3;
  ...
  (0, _useDebounce.default)(() => {
    if ((localState.activePalette !== activePalette || colorRangesToShow !== localState.colorRanges) && (0, _color_ranges_validation.isAllColorRangesValid)(localState.colorRanges)) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    ...
    idSelected: (_localState$activePal = localState.activePalette.params) !== null && _localState$activePal !== void 0 && _localState$activePal.rangeType ? `${idPrefix}${(_localState$activePal2 = localState.activePalette.params) === null || _localState$activePal2 === void 0 ? void 0 : _localState$activePal2.rangeType}` : `${idPrefix}percent`,
    onChange: id => {
