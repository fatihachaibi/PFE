...
export var getDocLinks = function getDocLinks(_ref) {
  ...
  return deepFreeze({
    ...
    workplaceSearch: {
      ...
      permissions: "".concat(WORKPLACE_SEARCH_DOCS, "workplace-search-permissions.html#organizational-sources-private-sources"),
    ...
    securitySolution: {
      trustedApps: "".concat(ELASTIC_WEBSITE_URL, "guide/en/security/").concat(DOC_LINK_VERSION, "/trusted-apps-ov.html"),
      eventFilters: "".concat(ELASTIC_WEBSITE_URL, "guide/en/security/").concat(DOC_LINK_VERSION, "/event-filters.html"),
      blocklist: "".concat(ELASTIC_WEBSITE_URL, "guide/en/security/").concat(DOC_LINK_VERSION, "/blocklist.html")
    },
    query: {
    ...
    endpoints: {
      troubleshooting: "".concat(ELASTIC_WEBSITE_URL, "guide/en/security/").concat(DOC_LINK_VERSION, "/ts-management.html#ts-endpoints")
    },
    legal: {
