 ...
 */
const getAllResults = input => (0, _rxjs.lastValueFrom)((0, _rxjs.from)(input).pipe((0, _operators.toArray)()));
/**
...
async function asyncMapWithLimit(iterable, limit, fn) {
  ...
  return results.sort(([a], [b]) => a - b).reduce((acc, [, result]) => acc.concat(result), []);
}