...
class ContextService {
  ...
  registerContextProvider({
    ...
    const subscription = context$.pipe((0, _operators.tap)(ctx => {
      if (this.isDevMode) {// TODO: In the future we may need to validate the input of the context based on the schema (only if isDev)
      }
    })).subscribe(context => {
      ...
      this.contextProvidersRegistry.set(name, context); // For every context change, we rebuild the global context.
