...
export var ContextService = /*#__PURE__*/function () {
  function ContextService(context$, isDevMode) {
  ...
  _createClass(ContextService, [{
    ...
    value: function registerContextProvider(_ref) {
      ...
      var subscription = context$.pipe(tap(function (ctx) {
        if (_this.isDevMode) {// TODO: In the future we may need to validate the input of the context based on the schema (only if isDev)
        }
