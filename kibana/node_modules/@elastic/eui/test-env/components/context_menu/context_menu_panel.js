...
var EuiContextMenuPanel = /*#__PURE__*/function (_Component) {
  ...
  function EuiContextMenuPanel(props) {
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "findMenuItems", function () {
      ...
      if (!((_this$props$items = _this.props.items) === null || _this$props$items === void 0 ? void 0 : _this$props$items.length)) return; // We only need menu items/arrow key navigation for the `items` API
    ...
    (0, _defineProperty2.default)((0, _assertThisInitialized2.default)(_this), "onKeyDown", function (event) {
      ...
      if (onClose && ((items === null || items === void 0 ? void 0 : items.length) || document.activeElement === _this.backButton || document.activeElement === _this.panel)) {
  ...
  (0, _createClass2.default)(EuiContextMenuPanel, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props2, ["children", "className", "onClose", "title", "onHeightChange", "transitionType", "transitionDirection", "onTransitionComplete", "onUseKeyboardToNavigate", "items", "initialFocusedItemIndex", "showNextPanel", "showPreviousPanel", "size"]);
      var panelTitle;
