...
var EuiSuperSelectControl = function EuiSuperSelectControl(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["className", "options", "id", "name", "fullWidth", "isLoading", "isInvalid", "readOnly", "defaultValue", "compressed", "value", "prepend", "append", "screenReaderId", "disabled"]);
