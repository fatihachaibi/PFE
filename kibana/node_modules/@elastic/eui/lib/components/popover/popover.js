  ...
  _createClass(EuiPopover, [{
    ...
    value: function render() {
      ...
      if (!this.state.suppressingPopover && (isOpen || this.state.isClosing)) {
        ...
        var ariaDescribedby;
        var ariaLive;
        var panelAriaModal = (panelProps === null || panelProps === void 0 ? void 0 : panelProps.hasOwnProperty('aria-modal')) ? panelProps['aria-modal'] : 'true';
        var panelRole = (panelProps === null || panelProps === void 0 ? void 0 : panelProps.hasOwnProperty('role')) ? panelProps.role : 'dialog';
