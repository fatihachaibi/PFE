...
var EuiSuggestItem = function EuiSuggestItem(_ref) {
  var className = _ref.className,
      ...
      rest = _objectWithoutProperties(_ref, ["className", "label", "type", "labelDisplay", "labelWidth", "description", "truncate", "descriptionDisplay", "onClick"]);
  ...
  var labelClassNames = (0, _classnames.default)('euiSuggestItem__label', _defineProperty({}, "euiSuggestItem__label--width".concat(labelWidth), labelDisplay === 'fixed'));
