  ...
  _createClass(EuiDualRange, [{
    ...
    value: function render() {
      ...
      var _this$props2 = this.props,
          ...
          rest = _objectWithoutProperties(_this$props2, ["className", "compressed", "disabled", "fullWidth", "isLoading", "readOnly", "id", "max", "min", "name", "step", "showLabels", "showInput", "showTicks", "tickInterval", "ticks", "levels", "onBlur", "onChange", "onFocus", "showRange", "value", "style", "isInvalid", "append", "prepend", "minInputProps", "maxInputProps", "isDraggable"]);
