...
var EuiButtonIcon = function EuiButtonIcon(_ref) {
  var className = _ref.className,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["className", "iconType", "iconSize", "color", "isDisabled", "disabled", "href", "type", "display", "target", "rel", "size", "buttonRef", "isSelected", "isLoading"]);
