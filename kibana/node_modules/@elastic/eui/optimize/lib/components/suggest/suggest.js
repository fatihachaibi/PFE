...
var EuiSuggest = function EuiSuggest(_ref) {
  var onItemClick = _ref.onItemClick,
      ...
      rest = (0, _objectWithoutProperties2.default)(_ref, ["onItemClick", "onBlur", "onFocus", "onInput", "onSearch", "status", "append", "tooltipContent", "suggestions", "id", "aria-label", "aria-labelledby", "isVirtualized", "fullWidth", "maxHeight"]);
