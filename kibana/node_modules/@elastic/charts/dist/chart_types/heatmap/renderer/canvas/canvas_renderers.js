                ...
                return theme.yAxisLabel.visible &&
                    (0, canvas_1.withContext)(ctx, function () {
                        ...
                        filteredYValues.forEach(function (_a) {
                            ...
                            var textLines = (0, text_1.wrapLines)(ctx, text, font, theme.yAxisLabel.fontSize, heatmapViewModel.gridOrigin.x - horizontalPadding, theme.yAxisLabel.fontSize, { shouldAddEllipsis: true, wrapAtWord: false }).lines;
