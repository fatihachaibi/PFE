...
class TelemetryPlugin {
  ...
  constructor(initializerContext) {
    ...
    (0, _defineProperty2.default)(this, "optInPollerSubscription", (0, _rxjs.timer)(0, _constants.OPT_IN_POLL_INTERVAL_MS).pipe((0, _rxjs.exhaustMap)(() => this.getOptInStatus()), (0, _rxjs.distinctUntilChanged)()).subscribe(isOptedIn => this.isOptedIn$.next(isOptedIn)));
  ...
  start(core, {
    ...
    this.isOptedIn$.pipe((0, _rxjs.filter)(isOptedIn => typeof isOptedIn === 'boolean')).subscribe(isOptedIn => analytics.optIn({
      global: {
        enabled: isOptedIn
      }
    }));
