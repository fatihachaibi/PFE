...
const isNumericFieldSelected = agg => {
  ...
  return field && field.type && field.type === _2.KBN_FIELD_TYPES.NUMBER;
};
...
const getTopHitMetricAgg = () => {
  return new _metric_agg_type.MetricAggType({
    ...
    params: [{
      ...
      filterFieldTypes: Object.values(_2.KBN_FIELD_TYPES).filter(type => type !== _2.KBN_FIELD_TYPES.HISTOGRAM),
        ...
        if (field.scripted) {
          ...
          if (field.name !== '_source') {
            output.params.fields = [{
              ...
              ...(field.type === _2.KBN_FIELD_TYPES.DATE && {
                format: 'date_time'
              })
            }];
          }
      ...
      name: 'sortField',
      type: 'field',
      filterFieldTypes: [_2.KBN_FIELD_TYPES.NUMBER, _2.KBN_FIELD_TYPES.DATE, _2.KBN_FIELD_TYPES.IP, _2.KBN_FIELD_TYPES.STRING],
