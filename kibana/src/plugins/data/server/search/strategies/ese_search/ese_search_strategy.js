...
const enhancedEsSearchStrategyProvider = (legacyConfig$, logger, usage, useInternalUser = false) => {
  ...
  function asyncSearch({
    ...
    return (0, _common.pollSearch)(search, cancel, options).pipe((0, _operators.tap)(response => id = response.id), (0, _operators.tap)((0, _search.searchUsageObserver)(logger, usage)), (0, _operators.catchError)(e => {
      throw (0, _server.getKbnServerError)(e);
    }));
  }
