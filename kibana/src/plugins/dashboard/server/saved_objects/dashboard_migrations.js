...
var _common3 = require("../../../controls/common");
...
const migrateByValuePanels = (migrate, version) => doc => {
  ...
  if (attributes !== null && attributes !== void 0 && attributes.controlGroupInput) {
    const controlGroupInput = (0, _common3.rawControlGroupAttributesToSerializable)(attributes.controlGroupInput);
    const migratedControlGroupInput = migrate({ ...controlGroupInput,
      type: _common3.CONTROL_GROUP_TYPE
    });
    attributes.controlGroupInput = (0, _common3.serializableToRawControlGroupAttributes)(migratedControlGroupInput);
