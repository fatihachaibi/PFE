...
class Executor {
  ...
  getFunction(name, namespace) {
    ...
    if (!(fn !== null && fn !== void 0 && fn.namespace) || fn.namespace === namespace) return fn;
  }
  ...
  getType(name) {
    var _this$container$get$t, _this$parent2;

    return (_this$container$get$t = this.container.get().types[name]) !== null && _this$container$get$t !== void 0 ? _this$container$get$t : (_this$parent2 = this.parent) === null || _this$parent2 === void 0 ? void 0 : _this$parent2.getType(name);
  }

  getTypes() {
    var _this$parent$getTypes, _this$parent3;

    return { ...((_this$parent$getTypes = (_this$parent3 = this.parent) === null || _this$parent3 === void 0 ? void 0 : _this$parent3.getTypes()) !== null && _this$parent$getTypes !== void 0 ? _this$parent$getTypes : {}),
      ...this.container.get().types
    };
  }

  get context() {
    var _this$parent$context, _this$parent4;

    return { ...((_this$parent$context = (_this$parent4 = this.parent) === null || _this$parent4 === void 0 ? void 0 : _this$parent4.context) !== null && _this$parent$context !== void 0 ? _this$parent$context : {}),
