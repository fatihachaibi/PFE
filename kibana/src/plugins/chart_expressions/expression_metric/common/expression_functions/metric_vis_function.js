 ...
 */
const errors = {
  severalMetricsAndColorFullBackgroundSpecifiedError: () => _i18n.i18n.translate('expressionMetricVis.function.errors.severalMetricsAndColorFullBackgroundSpecified', {
    defaultMessage: 'Full background coloring cannot be applied to a visualization with multiple metrics.'
  }),
  splitByBucketAndColorFullBackgroundSpecifiedError: () => _i18n.i18n.translate('expressionMetricVis.function.errors.splitByBucketAndColorFullBackgroundSpecified', {
...
const metricVisFunction = () => ({
  ...
  args: {
    ...
    colorFullBackground: {
      types: ['boolean'],
      default: false,
      help: _i18n.i18n.translate('expressionMetricVis.function.colorFullBackground.help', {
    ...
    labelFont: {
      types: ['style'],
      help: _i18n.i18n.translate('expressionMetricVis.function.labelFont.help', {
    ...
    labelPosition: {
      ...
      help: _i18n.i18n.translate('expressionMetricVis.function.labelPosition.help', {
    ...
    autoScale: {
      types: ['boolean'],
      help: _i18n.i18n.translate('expressionMetricVis.function.autoScale.help', {
