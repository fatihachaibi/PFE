...
exports.waffleVisFunction = void 0;
...
const waffleVisFunction = () => ({
  name: _constants2.WAFFLE_VIS_EXPRESSION_NAME,
  type: 'render',
  ...
  args: {
    ...
    bucket: {
      types: ['vis_dimension'],
      help: _i18n.strings.getBucketArgHelp()
    },
    splitColumn: {
      types: ['vis_dimension'],
    ...
    showValuesInLegend: {
      types: ['boolean'],
      help: _i18n.strings.getShowValuesInLegendArgHelp(),
      default: false
    },
    ariaLabel: {
      types: ['string'],
  ...
  fn(context, args, handlers) {
    ...
    if (args.bucket) {
      (0, _utils.validateAccessor)(args.bucket, context.columns);
    }
    ...
    if (handlers !== null && handlers !== void 0 && (_handlers$inspectorAd = handlers.inspectorAdapters) !== null && _handlers$inspectorAd !== void 0 && _handlers$inspectorAd.tables) {
      ...
      const logTable = (0, _utils.prepareLogTable)(context, [[[args.metric], _i18n.strings.getSliceSizeHelp()], [buckets, _i18n.strings.getSliceHelp()], [args.splitColumn, _i18n.strings.getColumnSplitHelp()], [args.splitRow, _i18n.strings.getRowSplitHelp()]], true);
    ...
    return {
      ...
      value: {
        ...
        visType: _types.ChartTypes.WAFFLE,
        params: {
          listenOnChange: true
        }
      }
...
exports.waffleVisFunction = waffleVisFunction;