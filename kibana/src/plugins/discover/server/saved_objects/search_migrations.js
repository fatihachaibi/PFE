...
exports.searchMigrations = exports.getAllMigrations = void 0;

var _lodash = require("lodash");

var _server = require("../../../../core/server");

var _server2 = require("../../../data/server");
        ...
        attributes: { ...doc.attributes,
          kibanaSavedObjectMeta: {
            searchSourceJSON: JSON.stringify({ ...searchSource,
              query: {
                query: '',
                language: _server2.DEFAULT_QUERY_LANGUAGE
              }
            })
          }
        }
...
const getSearchSourceMigrations = searchSourceMigrations => (0, _lodash.mapValues)(searchSourceMigrations, migrate => state => {
  const _state = state;
...
const getAllMigrations = searchSourceMigrations => {
  return (0, _server.mergeSavedObjectMigrationMaps)(searchMigrations, getSearchSourceMigrations(searchSourceMigrations));
};
