...
const createCachedFieldValueFormatter = (dataView, fields, fieldFormatService, options, excludedFieldFormatsIds = []) => {
  ...
  return (fieldName, value, contentType = 'text') => {
    ...
    if (dataView && !excludedFieldFormatsIds.includes((_dataView$fieldFormat = dataView.fieldFormatMap) === null || _dataView$fieldFormat === void 0 ? void 0 : (_dataView$fieldFormat2 = _dataView$fieldFormat[fieldName]) === null || _dataView$fieldFormat2 === void 0 ? void 0 : _dataView$fieldFormat2.id)) {
