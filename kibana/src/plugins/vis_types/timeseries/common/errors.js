...
exports.filterCannotBeAppliedErrorMessage = exports.ValidateIntervalError = exports.UIError = exports.TimeFieldNotSpecifiedError = exports.PivotNotSelectedForTableError = exports.FilterCannotBeAppliedError = exports.FieldNotFoundError = exports.DataViewNotFoundError = exports.AggNotSupportedError = void 0;
...
class DataViewNotFoundError extends UIError {
  constructor(dataViewId) {
    super(_i18n.i18n.translate('visTypeTimeseries.errors.dataViewNotFoundError', {
