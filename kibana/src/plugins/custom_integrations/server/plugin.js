...
var _external_integration = require("./external_integration");
...
class CustomIntegrationsPlugin {
  ...
  setup(core) {
    ...
    (0, _external_integration.registerExternalIntegrations)(core, this.customIngegrationRegistry, this.branch);
    return {
