...
class SavedObjectsRepository {
  ...
  async bulkCreate(objects, options = {}) {
    ...
    const expectedBulkResults = expectedResults.map(expectedBulkGetResult => {
      ...
      if (preflightCheckIndex !== undefined) {
        ...
        existingOriginId = existingDocument === null || existingDocument === void 0 ? void 0 : (_existingDocument$_so2 = existingDocument._source) === null || _existingDocument$_so2 === void 0 ? void 0 : _existingDocument$_so2.originId;
      } else {
  ...
  validateOriginId(type, objectOrOptions) {
    if (Object.keys(objectOrOptions).includes('originId') && !this._registry.isMultiNamespace(type)) {
      throw _errors.SavedObjectsErrorHelpers.createBadRequestError('"originId" can only be set for multi-namespace object types');
    }
  }
