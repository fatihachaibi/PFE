...
const model = (currentState, resW) => {
  ...
  if (Either.isLeft(resW)) {
    if ((0, _actions.isLeftTypeof)(resW.left, 'retryable_es_client_error')) {
  ...
  if (stateP.controlState === 'INIT') {
    ...
    if (Either.isLeft(res)) {
      ...
      if ((0, _actions.isLeftTypeof)(left, 'incompatible_cluster_routing_allocation')) {
    ...
    if (Either.isLeft(res)) {
      ...
      if ((0, _actions.isLeftTypeof)(left, 'index_not_yellow_timeout')) {
        ...
        return (0, _retry_state.delayRetryState)(stateP, retryErrorMessage, stateP.retryAttempts);
      } else if ((0, _actions.isLeftTypeof)(left, 'cluster_shard_limit_exceeded')) {
        return { ...stateP,
          controlState: 'FATAL',
    ...
    if (Either.isRight(res)) {
      ...
      } else if ((0, _actions.isLeftTypeof)(left, 'index_not_yellow_timeout')) {
