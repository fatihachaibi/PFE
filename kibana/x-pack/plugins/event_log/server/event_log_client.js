...
exports.queryOptionsSchema = queryOptionsSchema; // note that clusterClient may be null, indicating we can't write to ES
...
class EventLogClient {
  ...
  async findEventsBySavedObjectIds(type, ids, options, legacyIds) {
    const findOptions = queryOptionsSchema.validate(options !== null && options !== void 0 ? options : {}); // verify the user has the required permissions to view this saved object
  ...
  async aggregateEventsBySavedObjectIds(type, ids, options, legacyIds) {
    ...
    const aggregateOptions = queryOptionsSchema.validate((_omit = (0, _lodash.omit)(options, 'aggs')) !== null && _omit !== void 0 ? _omit : {}); // verify the user has the required permissions to view this saved object
  ...
  async getNamespace() {
    ...
    return space && ((_this$spacesService2 = this.spacesService) === null || _this$spacesService2 === void 0 ? void 0 : _this$spacesService2.spaceIdToNamespace(space.id));
  }
