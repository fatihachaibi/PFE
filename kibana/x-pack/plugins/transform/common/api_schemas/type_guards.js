...
const isResetTransformsResponseSchema = arg => {
  return (0, _shared_imports.isPopulatedObject)(arg) && Object.values(arg).every(d => (0, _shared_imports.isPopulatedObject)(d, ['transformReset']));
};
...
const isEsIngestPipelines = arg => {
  return Array.isArray(arg) && arg.every(d => (0, _shared_imports.isPopulatedObject)(d, ['name']));
};
