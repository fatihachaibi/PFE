...
const APP_CLUSTER_PRIVILEGES = ['cluster:monitor/transform/get', 'cluster:monitor/transform/stats/get', 'cluster:admin/transform/delete', 'cluster:admin/transform/preview', 'cluster:admin/transform/put', 'cluster:admin/transform/reset', 'cluster:admin/transform/start', 'cluster:admin/transform/start_task', 'cluster:admin/transform/stop']; // Minimum privileges required to return transform node count

exports.APP_CLUSTER_PRIVILEGES = APP_CLUSTER_PRIVILEGES;
const NODES_INFO_PRIVILEGES = ['cluster:monitor/transform/get']; // Equivalent of capabilities.canGetTransform

exports.NODES_INFO_PRIVILEGES = NODES_INFO_PRIVILEGES;
const APP_GET_TRANSFORM_CLUSTER_PRIVILEGES = ['cluster.cluster:monitor/transform/get', 'cluster.cluster:monitor/transform/stats/get']; // Equivalent of capabilities.canCreateTransform
