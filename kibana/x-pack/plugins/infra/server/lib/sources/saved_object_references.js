...
const extractSavedObjectReferences = (0, _references.extractSavedObjectReferences)([extractLogIndicesSavedObjectReferences, extractInventorySavedViewReferences, extractMetricsExplorerSavedViewReferences]);
/**
 * Rewrites a source configuration such that well-known saved object references
...
const resolveSavedObjectReferences = (0, _references.resolveSavedObjectReferences)([resolveLogIndicesSavedObjectReferences, resolveInventoryViewSavedObjectReferences, resolveMetricsExplorerSavedObjectReferences]);
