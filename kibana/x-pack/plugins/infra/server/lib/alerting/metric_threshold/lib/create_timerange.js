...
const createTimerange = (interval, aggType, timeframe, lastPeriodEnd) => {
  ...
  const calculatedFrom = lastPeriodEnd ? lastPeriodEnd - interval : to - interval * minimumBuckets; // Use either the timeframe.start when the start is less then calculatedFrom
