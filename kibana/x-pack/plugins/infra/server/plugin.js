...
class InfraServerPlugin {
  ...
  setup(core, plugins) {
    ...
    const logViews = this.logViews.setup(); // register saved object types
    ...
    core.savedObjects.registerType(_saved_objects.logViewSavedObjectType); // TODO: separate these out individually and do away with "domains" as a temporary group
    ...
    logEntriesService.setup(core, plugins); // register deprecated source configuration fields
