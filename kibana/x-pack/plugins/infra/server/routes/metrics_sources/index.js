...
const initMetricsSourceConfigurationRoutes = libs => {
  ...
  framework.registerRoute({
    ...
    try {
      ...
      const patchedSourceConfiguration = await (sourceConfigurationExists ? sources.updateSourceConfiguration(soClient, sourceId, // @ts-ignore
      patchedSourceConfigurationProperties) : sources.createSourceConfiguration(soClient, sourceId, // @ts-ignore
