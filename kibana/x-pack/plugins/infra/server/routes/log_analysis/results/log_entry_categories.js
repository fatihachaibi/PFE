  ...
  framework.registerRoute({
    ...
    try {
      ...
      const {
        ...
        timing
      } = await (0, _log_analysis2.getTopLogEntryCategories)({
        infra: await infraMlContext.infra
      }, sourceId, startTime, endTime, categoryCount, datasets !== null && datasets !== void 0 ? datasets : [], histograms.map(histogram => ({
