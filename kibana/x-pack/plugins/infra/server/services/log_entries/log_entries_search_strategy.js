...
const logEntriesSearchStrategyProvider = ({
  ...
  return {
    search: (rawRequest, options, dependencies) => (0, _rxjs.defer)(() => {
      ...
      const resolvedLogView$ = (0, _rxjs.defer)(() => logViews.getScopedClient(dependencies.request).getResolvedLogView(request.params.sourceId)).pipe((0, _operators.take)(1), (0, _operators.shareReplay)(1));
      const messageFormattingRules$ = (0, _rxjs.defer)(() => resolvedLogView$.pipe((0, _operators.map)(({
        messageField
      ...
      const initialRequest$ = (0, _rxjs.of)(request).pipe((0, _operators.filter)(asyncInitialRequestRT.is), (0, _operators.concatMap)(({
        params
      }) => (0, _rxjs.forkJoin)([resolvedLogView$, messageFormattingRules$]).pipe((0, _operators.map)(([{
        indices,
        timestampField,
        tiebreakerField,
        columns,
      ...
      return (0, _rxjs.combineLatest)([searchResponse$, resolvedLogView$, messageFormattingRules$]).pipe((0, _operators.map)(([esResponse, {
        columns
      }, messageFormattingRules]) => {
