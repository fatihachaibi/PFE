...
class LogViewsClient {
  ...
  async putLogView(logViewId, logViewAttributes) {
    ...
    const logViewAttributesWithDefaults = { ..._log_views.defaultLogViewAttributes,
      ...logViewAttributes
    };
    const {
      attributes,
  ...
  async resolveLogView(logViewAttributes) {
    return await (0, _log_views.resolveLogView)(logViewAttributes, await this.dataViews, this.config);
  }
