  ...
  router.get({
    ...
    try {
      ...
      const oneIndexWithAllPrivileges = indices.find(({
        ...
        const indexHasAllPrivileges = _common.APP_RESTORE_INDEX_PRIVILEGES.every(privilege => // @ts-expect-error SecurityClusterPrivilege doesn’t list all the possible privileges.
