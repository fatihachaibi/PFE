...
exports.DynamicSettingsType = exports.DynamicSettingsSaveType = void 0;
...
const DefaultEmailType = t.intersection([t.type({
  to: t.array(t.string)
}), t.partial({
  cc: t.array(t.string),
  bcc: t.array(t.string)
})]);
const DynamicSettingsType = t.intersection([t.strict({
