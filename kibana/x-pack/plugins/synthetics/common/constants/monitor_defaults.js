...
const DEFAULT_BROWSER_SIMPLE_FIELDS = { ...DEFAULT_COMMON_FIELDS,
...
const DEFAULT_HTTP_SIMPLE_FIELDS = { ...DEFAULT_COMMON_FIELDS,
  [_monitor_management2.ConfigKey.METADATA]: {
...
const DEFAULT_ICMP_SIMPLE_FIELDS = { ...DEFAULT_COMMON_FIELDS,
...
const DEFAULT_TCP_SIMPLE_FIELDS = { ...DEFAULT_COMMON_FIELDS,
  [_monitor_management2.ConfigKey.METADATA]: {
    is_tls_enabled: false
  },
  [_monitor_management2.ConfigKey.HOSTS]: '',
...
const DEFAULT_FIELDS = {
  [_monitor_management.DataStream.HTTP]: { ...DEFAULT_HTTP_SIMPLE_FIELDS,
    ...DEFAULT_HTTP_ADVANCED_FIELDS,
    ...DEFAULT_TLS_FIELDS
  },
  [_monitor_management.DataStream.TCP]: { ...DEFAULT_TCP_SIMPLE_FIELDS,
    ...DEFAULT_TCP_ADVANCED_FIELDS,
    ...DEFAULT_TLS_FIELDS
  },
  [_monitor_management.DataStream.ICMP]: DEFAULT_ICMP_SIMPLE_FIELDS,
  [_monitor_management.DataStream.BROWSER]: { ...DEFAULT_BROWSER_SIMPLE_FIELDS,
