...
const uptimeFeature = {
  ...
  privileges: {
    all: {
      ...
      savedObject: {
        all: [_uptime_settings.umDynamicSettings.name, _synthetics_monitor.syntheticsMonitorType, _service_api_key.syntheticsApiKeyObjectType],
        read: []
      },
      alerting: {
        rule: {
    ...
    read: {
      ...
      savedObject: {
        all: [],
        read: [_uptime_settings.umDynamicSettings.name, _synthetics_monitor.syntheticsMonitorType, _service_api_key.syntheticsApiKeyObjectType]
      },
      alerting: {
        rule: {
