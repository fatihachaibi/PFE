  ...
  handler: async ({
    ...
    try {
      const {
        ...
        perPage: 1,
        page: 1,
        filter: `${_saved_objects.syntheticsMonitorType}.id: "${_saved_objects.syntheticsMonitorType}:${monitorId}" OR ${_saved_objects.syntheticsMonitorType}.attributes.${_runtime_types.ConfigKey.CUSTOM_HEARTBEAT_ID}: "${monitorId}"`
      });
