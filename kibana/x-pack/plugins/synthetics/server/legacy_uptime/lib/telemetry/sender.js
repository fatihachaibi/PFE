...
class TelemetryEventsSender {
  ...
  async send(events, telemetryUrl) {
    ...
    } = (_this$clusterInfo = this.clusterInfo) !== null && _this$clusterInfo !== void 0 ? _this$clusterInfo : {}; // using ndjson so that each line will be wrapped in json envelope on server side
