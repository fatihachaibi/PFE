...
const formatColumnFn = (input, {
  ...
  columns: input.columns.map(col => {
    if (col.id === columnId) {
      ...
      const parentFormatParams = (_parsedParentFormat$p = parsedParentFormat.params) !== null && _parsedParentFormat$p !== void 0 ? _parsedParentFormat$p : {}; // Be careful here to check for undefined custom format
      ...
      if (format && _supported_formats.supportedFormats[format]) {
        ...
        if ((_col$meta$params2 = col.meta.params) !== null && _col$meta$params2 !== void 0 && (_col$meta$params2$par = _col$meta$params2.params) !== null && _col$meta$params2$par !== void 0 && (_col$meta$params2$par2 = _col$meta$params2$par.paramsPerField) !== null && _col$meta$params2$par2 !== void 0 && _col$meta$params2$par2.length) {
          ...
          return withParams(col, {
            ...
            params: { ...((_col$meta$params3 = col.meta.params) === null || _col$meta$params3 === void 0 ? void 0 : _col$meta$params3.params),
              ...
              paramsPerField: (_col$meta$params4 = col.meta.params) === null || _col$meta$params4 === void 0 ? void 0 : (_col$meta$params4$par = _col$meta$params4.params) === null || _col$meta$params4$par === void 0 ? void 0 : _col$meta$params4$par.paramsPerField.map(f => ({ ...f,
                params: { ...f.params,
                  ...customParams
                },
                ...customParams
        ...
        return withParams(col, {
          id: parentFormatId,
          params: { ...((_col$meta$params5 = col.meta.params) === null || _col$meta$params5 === void 0 ? void 0 : _col$meta$params5.params),
            id: format,
            // some wrapper formatters require params to be flatten out (i.e. terms) while others
            // require them to be in the params property (i.e. ranges)
            // so for now duplicate
      ...
      if (parentFormatParams) {
        var _col$meta$params6, _col$meta$params7, _col$meta$params8, _col$meta$params9; // if original format is already a nested one, we are just replacing the wrapper params
