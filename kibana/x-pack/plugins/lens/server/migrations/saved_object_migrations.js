  ...
  try {
    ...
    return { ...doc,
      attributes: { ...doc.attributes,
        expression: (0, _interpreter.toExpression)({ ...ast,
          chain: newChain
        })
      }
    };
...
const lockOldMetricVisSettings = doc => ({ ...doc,
  attributes: (0, _common_migrations.commonLockOldMetricVisSettings)(doc.attributes)
});

const preserveOldLegendSizeDefault = doc => ({ ...doc,
...
const getAllMigrations = (filterMigrations, customVisualizationMigrations) => (0, _server.mergeSavedObjectMigrationMaps)((0, _server.mergeSavedObjectMigrationMaps)(lensMigrations, (0, _common_migrations.getLensFilterMigrations)(filterMigrations)), (0, _common_migrations.getLensCustomVisualizationMigrations)(customVisualizationMigrations));
