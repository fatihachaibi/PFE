...
exports.getCasesFromAlertsUrl = exports.getCaseUserActionUrl = exports.getCasePushUrl = exports.getCaseDetailsUrl = exports.getCaseDetailsMetricsUrl = exports.getCaseConfigurationDetailsUrl = exports.getCaseCommentsUrl = exports.getCaseCommentDetailsUrl = exports.getCaseCommentDeleteUrl = void 0;
...
const getCaseCommentDeleteUrl = (caseId, commentId) => {
  return _constants.CASE_COMMENT_DELETE_URL.replace('{case_id}', caseId).replace('{comment_id}', commentId);
};

exports.getCaseCommentDeleteUrl = getCaseCommentDeleteUrl;
