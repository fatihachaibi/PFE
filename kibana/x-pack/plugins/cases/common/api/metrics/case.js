...
exports.SingleCaseMetricsResponseRt = exports.SingleCaseMetricsRequestRt = exports.CasesMetricsResponseRt = exports.CasesMetricsRequestRt = void 0;
...
const SingleCaseMetricsRequestRt = rt.type({
  /**
   * The ID of the case.
   */
  caseId: rt.string,
...
exports.SingleCaseMetricsRequestRt = SingleCaseMetricsRequestRt;
const CasesMetricsRequestRt = rt.intersection([rt.type({
  /**
   * The metrics to retrieve.
   */
  features: rt.array(rt.string)
...
exports.CasesMetricsRequestRt = CasesMetricsRequestRt;
const SingleCaseMetricsResponseRt = rt.partial(rt.type({
...
exports.SingleCaseMetricsResponseRt = SingleCaseMetricsResponseRt;
const CasesMetricsResponseRt = rt.partial(rt.type({
  /**
   * The average resolve time of all cases in seconds
   */
  mttr: rt.union([rt.number, rt.null])
}).props);
exports.CasesMetricsResponseRt = CasesMetricsResponseRt;