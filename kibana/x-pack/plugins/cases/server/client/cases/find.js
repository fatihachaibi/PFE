...
const find = async (params, clientArgs) => {
  ...
  try {
    ...
    const queryParams = (0, _pipeable.pipe)((0, _api.excess)(_api.CasesFindRequestRt).decode({ ...params,
      fields
    ...
    const statusStatsOptions = (0, _utils2.constructQueryOptions)({ ...queryArgs,
      status: undefined,
      authorizationFilter
    });
    const caseQueryOptions = (0, _utils2.constructQueryOptions)({ ...queryArgs,
      authorizationFilter
    });
