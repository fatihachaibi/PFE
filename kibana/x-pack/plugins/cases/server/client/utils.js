...
exports.combineAuthorizedAndOwnerFilter = exports.buildRangeFilter = exports.buildFilter = exports.addStatusFilter = exports.addSeverityFilter = void 0;
...
const constructQueryOptions = ({
  ...
  const filters = [statusFilter, severityFilter, tagsFilter, reportersFilter, rangeFilter, ownerFilter].filter(kueryNodeExists);
