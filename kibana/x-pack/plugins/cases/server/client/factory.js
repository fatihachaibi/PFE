...
class CasesClientFactory {
  ...
  async create({
    ...
    const attachmentService = new _services.AttachmentService(this.logger);
    const caseService = new _services.CasesService({
      log: this.logger,
      authentication: (_this$options = this.options) === null || _this$options === void 0 ? void 0 : (_this$options$securit3 = _this$options.securityPluginStart) === null || _this$options$securit3 === void 0 ? void 0 : _this$options$securit3.authc,
