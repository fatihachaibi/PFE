...
class CaseCommentModel {
  ...
  async updateComment({
    ...
    try {
      ...
      const [comment, commentableCase] = await Promise.all([this.params.attachmentService.update({
        unsecuredSavedObjectsClient: this.params.unsecuredSavedObjectsClient,
        attachmentId: id,
  ...
  async updateCaseUserAndDate(date) {
    try {
      ...
      return this.newObjectWithInfo({ ...this.caseInfo,
  ...
  async createComment({
    ...
    try {
      ...
      const [comment, commentableCase] = await Promise.all([this.params.attachmentService.create({
        unsecuredSavedObjectsClient: this.params.unsecuredSavedObjectsClient,
  ...
  async bulkCreate({
    ...
    try {
      ...
      const [newlyCreatedAttachments, commentableCase] = await Promise.all([this.params.attachmentService.bulkCreate({
        unsecuredSavedObjectsClient: this.params.unsecuredSavedObjectsClient,
        attachments: attachments.map(({
          id,
          ...attachment
