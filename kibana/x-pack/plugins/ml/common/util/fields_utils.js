...
exports.filterCategoryFields = filterCategoryFields;
...
const categoryFieldTypes = [_common.ES_FIELD_TYPES.TEXT, _common.ES_FIELD_TYPES.KEYWORD, _common.ES_FIELD_TYPES.IP, _common.ES_FIELD_TYPES.VERSION]; // cross reference fields and aggs.
...
function getKeywordFields(fields) {
  return fields.filter(f => f.type === _common.ES_FIELD_TYPES.KEYWORD || f.type === _common.ES_FIELD_TYPES.VERSION);
}
...
function filterCategoryFields(fields, include = true) {
