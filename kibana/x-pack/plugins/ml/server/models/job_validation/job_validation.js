...
async function validateJob(client, mlClient, payload, authHeader, isSecurityDisabled) {
  ...
  try {
    ...
    if (basicValidation.valid === true) {
      var _job$analysis_config, _duration, _duration2; // remove basic success messages from tests
      ...
      validationMessages.push(...(await (0, _validate_datafeed_preview.validateDatafeedPreviewWithMessages)(mlClient, authHeader, job, (_duration = duration) === null || _duration === void 0 ? void 0 : _duration.start, (_duration2 = duration) === null || _duration2 === void 0 ? void 0 : _duration2.end)));
    } else {
