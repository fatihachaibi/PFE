...
const getAnomalyChartsSchema = _configSchema.schema.object({
  jobIds: _configSchema.schema.arrayOf(_configSchema.schema.string()),
...
exports.getAnomalyChartsSchema = getAnomalyChartsSchema;

const getAnomalyRecordsSchema = _configSchema.schema.object({
  jobIds: _configSchema.schema.arrayOf(_configSchema.schema.string()),
  threshold: _configSchema.schema.number({
    defaultValue: 0,
    min: 0,
...
exports.getAnomalyRecordsSchema = getAnomalyRecordsSchema;