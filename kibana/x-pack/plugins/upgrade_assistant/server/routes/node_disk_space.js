    ...
    try {
      ...
      if (lowDiskWatermarkSetting) {
        ...
        nodeIds.forEach(nodeId => {
          ...
          const byteStats = node === null || node === void 0 ? void 0 : (_node$fs = node.fs) === null || _node$fs === void 0 ? void 0 : _node$fs.total; // @ts-expect-error @elastic/elasticsearch not supported
