...
class CsvGenerator {
  ...
  async scan(index, searchSource, settings) {
    ...
    const results = (await (0, _rxjs.lastValueFrom)(this.clients.data.search(searchParams, {
  ...
  async generateData() {
    ...
    try {
      ...
      if (err instanceof _elasticsearch.errors.ResponseError) {
        ...
        warnings.push(_i18n_texts.i18nTexts.unknownError(err === null || err === void 0 ? void 0 : err.message));
      }
    } finally {
      // clear scrollID
      if (scrollId) {
