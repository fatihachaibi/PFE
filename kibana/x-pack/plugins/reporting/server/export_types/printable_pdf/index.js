...
const getExportType = () => ({ ..._metadata.metadata,
  jobType: _constants.PDF_JOB_TYPE,
  jobContentEncoding: 'base64',
  jobContentExtension: 'pdf',
  createJobFnFactory: _create_job.createJobFnFactory,
  runTaskFnFactory: _execute_job.runTaskFnFactory,
  validLicenses: [_constants.LICENSE_TYPE_TRIAL, _constants.LICENSE_TYPE_CLOUD_STANDARD, _constants.LICENSE_TYPE_GOLD, _constants.LICENSE_TYPE_PLATINUM, _constants.LICENSE_TYPE_ENTERPRISE]
});
