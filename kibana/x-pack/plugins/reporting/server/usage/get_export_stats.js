...
const defaultTotalsForFeature = {
  ...
  output_size: ['1.0', '5.0', '25.0', '50.0', '75.0', '95.0', '99.0'].reduce((sps, p) => ({ ...sps,
    [p]: null
  }), {}),
  layout: {
    canvas: 0,
...
const metricsPercentiles = ['50.0', '75.0', '95.0', '99.0'].reduce((mps, p) => ({ ...mps,
  [p]: null
}), {});
const metricsSets = {
  csv: {
...
function getAvailableTotalForFeature(jobType, exportType, featureAvailability) {
  ...
  const deprecated = jobTypeIsDeprecated(exportType) ? jobType === null || jobType === void 0 ? void 0 : jobType.total : (jobType === null || jobType === void 0 ? void 0 : jobType.deprecated) || 0; // merge given stats with defaults

  const availableTotal = {
    available: isAvailable(featureAvailability, exportType),
    total: (jobType === null || jobType === void 0 ? void 0 : jobType.total) || 0,
    deprecated,
    output_size: { ...defaultTotalsForFeature.output_size,
      ...(jobType === null || jobType === void 0 ? void 0 : jobType.output_size)
    },
    metrics: { ...metricsForFeature[exportType],
    ...
    layout: jobTypeIsPdf(exportType) ? { ...defaultTotalsForFeature.layout,
...
const getExportStats = (rangeStatsInput, featureAvailability, exportTypesHandler) => {
  ...
  const statsForExportType = exportTypesHandler.getJobTypes().reduce((accum, exportType) => ({ ...accum,
