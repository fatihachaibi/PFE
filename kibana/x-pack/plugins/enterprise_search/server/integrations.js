...
const workplaceSearchIntegrations = [{
  ...
  description: _i18n.i18n.translate('xpack.enterpriseSearch.workplaceSearch.integrations.networkDriveDescription', {
    defaultMessage: 'Search over your files and folders stored on network drives with Enterprise Search.'
  }),
...
const registerEnterpriseSearchIntegrations = (http, customIntegrations) => {
  ...
  customIntegrations.registerCustomIntegration({
    ...
    title: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.integrations.webCrawlerName', {
      defaultMessage: 'Web site crawler'
    }),
    description: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.integrations.webCrawlerDescription', {
  ...
  customIntegrations.registerCustomIntegration({
    id: 'app_search_api',
    title: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.integrations.apiName', {
      defaultMessage: 'API'
    }),
    description: _i18n.i18n.translate('xpack.enterpriseSearch.appSearch.integrations.apiDescription', {
