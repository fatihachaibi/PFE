...
var _indices = require("./routes/enterprise_search/indices");
...
class EnterpriseSearchPlugin {
  ...
  setup({
    ...
    const PLUGIN_IDS = [_constants.ENTERPRISE_SEARCH_OVERVIEW_PLUGIN.ID, _constants.ELASTICSEARCH_PLUGIN.ID, _constants.APP_SEARCH_PLUGIN.ID, _constants.WORKPLACE_SEARCH_PLUGIN.ID];
    ...
    (0, _indices.registerListRoute)(dependencies);
    /**
