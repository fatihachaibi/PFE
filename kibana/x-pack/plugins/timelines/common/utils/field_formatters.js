...
exports.isRuleParametersFieldOrSubfield = exports.isGeoField = exports.getFieldCategory = exports.getDataSafety = exports.getDataFromSourceHits = exports.getDataFromFieldsHits = exports.formatGeoLocation = exports.baseCategoryFields = void 0;
...
const isRuleParametersFieldOrSubfield = (field, prependField) => (prependField === null || prependField === void 0 ? void 0 : prependField.includes(_ruleDataUtils.ALERT_RULE_PARAMETERS)) || field === _ruleDataUtils.ALERT_RULE_PARAMETERS;

exports.isRuleParametersFieldOrSubfield = isRuleParametersFieldOrSubfield;

const getDataFromSourceHits = (sources, category, path) => Object.keys(sources !== null && sources !== void 0 ? sources : {}).reduce((accumulator, source) => {
