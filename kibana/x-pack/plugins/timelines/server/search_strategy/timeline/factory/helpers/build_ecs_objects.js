...
var _build_object_for_field_path = require("./build_object_for_field_path");
...
const buildEcsObjects = hit => {
  ...
  return ecsFields.reduce((acc, field) => {
    ...
    if (nestedParentPath != null || (0, _fp.has)(field, hit._source) || (0, _fp.has)(field, hit.fields) || _constants.ECS_METADATA_FIELDS.includes(field)) {
      return (0, _fp.merge)(acc, (0, _build_object_for_field_path.buildObjectForFieldPath)(field, hit));
    }
