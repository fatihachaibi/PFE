...
const mergeTimelineFieldsWithHit = async (fieldName, flattenedFields, hit, dataFields, ecsFields) => {
  if (fieldName != null) {
    ...
    if (nestedParentPath != null || (0, _fp.has)(fieldName, hit._source) || (0, _fp.has)(fieldName, hit.fields) || _constants.ECS_METADATA_FIELDS.includes(fieldName)) {
      const objectWithProperty = {
        node: { ...(0, _fp.get)('node', flattenedFields),
          ...
          ecs: ecsFields.includes(fieldName) ? { ...(0, _fp.get)('node.ecs', flattenedFields),
            ...(0, _build_object_for_field_path.buildObjectForFieldPath)(fieldName, hit)
