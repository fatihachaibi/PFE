...
const requestIndexFieldSearch = async (request, {
  ...
  let indicesExist = [];
  let indexFields = [];
  let runtimeMappings = {}; // if dataViewId is provided, get fields and indices from the Kibana Data View
  ...
  if ('dataViewId' in request) {
    ...
    try {
      ...
      if (r.output.payload.statusCode === 404 && // this is the only place this id is hard coded as there are no security_solution dependencies in timeline
