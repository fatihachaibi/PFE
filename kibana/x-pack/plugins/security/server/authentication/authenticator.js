      ...
      if (!authenticationResult.notHandled()) {
        ...
        if (authenticationResult.user || authenticationResult.failed()) {
          ...
          auditLogger.log((0, _audit.userLoginEvent)({
            ...
            sessionId: sessionUpdateResult === null || sessionUpdateResult === void 0 ? void 0 : (_sessionUpdateResult$ = sessionUpdateResult.value) === null || _sessionUpdateResult$ === void 0 ? void 0 : _sessionUpdateResult$.sid,
            authenticationResult,
  ...
  *providerIterator(suggestedProviderName) {
  ...
  async invalidateSessionValue({
    ...
    if (sessionValue && !skipAuditEvent) {
      const auditLogger = this.options.audit.asScoped(request);
      auditLogger.log((0, _audit.userLogoutEvent)({
  ...
  handlePreAccessRedirects(request, authenticationResult, sessionUpdateResult, redirectURL) {
    ...
    } else if (isUpdatedSessionAuthenticated && this.shouldRedirectToAccessAgreement((_sessionUpdateResult$2 = sessionUpdateResult === null || sessionUpdateResult === void 0 ? void 0 : sessionUpdateResult.value) !== null && _sessionUpdateResult$2 !== void 0 ? _sessionUpdateResult$2 : null)) {
