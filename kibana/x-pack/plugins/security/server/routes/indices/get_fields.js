...
function defineGetFieldsRoutes({
  ...
  router.get({
    ...
    try {
      ...
      const customResponse = (0, _errors.wrapIntoCustomErrorResponse)(error); // Elasticsearch returns a 404 response if the provided pattern does not match any indices.
