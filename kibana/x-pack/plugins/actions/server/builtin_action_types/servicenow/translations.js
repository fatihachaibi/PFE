...
const CREDENTIALS_ERROR = _i18n.i18n.translate('xpack.actions.builtin.configuration.apiCredentialsError', {
  defaultMessage: 'Either basic auth or OAuth credentials must be specified'
});

exports.CREDENTIALS_ERROR = CREDENTIALS_ERROR;

const BASIC_AUTH_CREDENTIALS_ERROR = _i18n.i18n.translate('xpack.actions.builtin.configuration.apiBasicAuthCredentialsError', {
...
const OAUTH_CREDENTIALS_ERROR = _i18n.i18n.translate('xpack.actions.builtin.configuration.apiOAuthCredentialsError', {
  defaultMessage: 'clientSecret and privateKey must both be specified'
});

exports.OAUTH_CREDENTIALS_ERROR = OAUTH_CREDENTIALS_ERROR;

const VALIDATE_OAUTH_MISSING_FIELD_ERROR = (field, isOAuth) => _i18n.i18n.translate('xpack.actions.builtin.configuration.apiValidateMissingOAuthFieldError', {
...
const VALIDATE_OAUTH_POPULATED_FIELD_ERROR = (field, isOAuth) => _i18n.i18n.translate('xpack.actions.builtin.configuration.apiValidateOAuthFieldError', {
