...
async function getTotalCount(esClient, kibanaIndex, logger, preconfiguredActions) {
...
async function getInUseTotalCount(esClient, kibanaIndex, logger, referenceType, preconfiguredActions) {
  const scriptedMetric = {
    scripted_metric: {
...
async function getInUseByAlertingTotalCounts(esClient, kibanaIndex, logger, preconfiguredActions) {
