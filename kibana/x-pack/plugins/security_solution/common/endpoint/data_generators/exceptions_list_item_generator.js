...
const EFFECTIVE_SCOPE = [`${_constants.BY_POLICY_ARTIFACT_TAG_PREFIX}123-456`, // Policy Specific
...
class ExceptionsListItemGenerator extends _base_data_generator.BaseDataGenerator {
  ...
  generateTrustedAppForCreate(overrides = {}) {
    return { ...exceptionItemToCreateExceptionItem(this.generateTrustedApp()),
      ...overrides
    };
  }

  generateTrustedAppForUpdate(overrides = {}) {
    return { ...exceptionItemToUpdateExceptionItem(this.generateTrustedApp()),
      ...overrides
    };
  }
  ...
  generateEventFilterForCreate(overrides = {}) {
    return { ...exceptionItemToCreateExceptionItem(this.generateEventFilter()),
      ...overrides
    };
  }

  generateEventFilterForUpdate(overrides = {}) {
    return { ...exceptionItemToUpdateExceptionItem(this.generateEventFilter()),
      ...overrides
    };
  }
  ...
  generateHostIsolationExceptionForCreate(overrides = {}) {
    return { ...exceptionItemToCreateExceptionItem(this.generateHostIsolationException()),
      ...overrides
    };
  }

  generateHostIsolationExceptionForUpdate(overrides = {}) {
    return { ...exceptionItemToUpdateExceptionItem(this.generateHostIsolationException()),
      ...overrides
    };
  }
  ...
  generateBlocklistForCreate(overrides = {}) {
    return { ...exceptionItemToCreateExceptionItem(this.generateBlocklist()),
      ...overrides
    };
  }

  generateBlocklistForUpdate(overrides = {}) {
    return { ...exceptionItemToUpdateExceptionItem(this.generateBlocklist()),
      ...overrides
    };
  }
