...
exports.categoryMapping = exports.RelatedEventCategory = exports.EndpointDocGenerator = exports.ECSCategory = exports.ANCESTRY_LIMIT = void 0;
...
function getTreeOptionsWithDef(options) {
  var _options$ancestors, _options$generations, _options$children, _options$relatedEvent, _options$relatedEvent2, _options$relatedAlert, _options$sessionEntry, _options$percentWithR, _options$percentTermi, _options$alwaysGenMax, _options$ancestryArra, _options$eventsDataSt, _options$alertsDataSt;
  ...
  return {
    ...
    sessionEntryLeader: (_options$sessionEntry = options === null || options === void 0 ? void 0 : options.sessionEntryLeader) !== null && _options$sessionEntry !== void 0 ? _options$sessionEntry : '',
...
(function (AlertTypes) {
  AlertTypes["MALWARE"] = "MALWARE";
  AlertTypes["MEMORY_SIGNATURE"] = "MEMORY_SIGNATURE";
  AlertTypes["MEMORY_SHELLCODE"] = "MEMORY_SHELLCODE";
  AlertTypes["BEHAVIOR"] = "BEHAVIOR";
...
class EndpointDocGenerator extends _base_data_generator.BaseDataGenerator {
  ...
  constructor(seed = Math.random().toString()) {
    super(seed);
    (0, _defineProperty2.default)(this, "commonInfo", void 0);
  ...
  createHostData() {
    ...
    return {
      ...
      Endpoint: {
        ...
        capabilities: (0, _lte.default)(minCapabilitiesVersion, agentVersion) ? capabilities : []
      }
    };
  }
  /**
  ...
  generateMemoryAlert({
    ...
    const newAlert = { ...this.commonInfo,
      data_stream: alertsDataStream,
      '@timestamp': ts,
      ecs: {
        version: '1.6.0'
  ...
  generateAlert({
    ...
    switch (alertType) {
      ...
      default:
        return (0, _std.assertNever)(alertType);
    }
  }
  /**
   * Creates a memory alert from the simulated host represented by this EndpointDocGenerator
  ...
  generateEvent(options = {}) {
    ...
    const sessionEntryLeader = options.sessionEntryLeader ? options.sessionEntryLeader : this.randomString(10);
