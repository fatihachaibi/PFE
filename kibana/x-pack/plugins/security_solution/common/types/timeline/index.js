...
var _exportNames = {
  ...
  AllTimelineSavedObjectRuntimeType: true,
...
exports.sortTimeline = exports.sortFieldTimeline = exports.responseFavoriteTimeline = exports.pageInfoTimeline = exports.importTimelineResultSchema = exports.getTimelinesArgs = exports.direction = exports.allTimelinesResponse = exports.TimelineTypeLiteralWithNullRt = exports.TimelineTypeLiteralRt = exports.TimelineType = exports.TimelineTabs = exports.TimelineStatusLiteralRt = exports.TimelineStatus = exports.TimelineSavedToReturnObjectRuntimeType = exports.TimelineResponseType = exports.TimelineIdLiteralRt = exports.TimelineId = exports.TimelineErrorResponseType = exports.TemplateTimelineTypeLiteralWithNullRt = exports.TemplateTimelineTypeLiteralRt = exports.TemplateTimelineType = exports.SortFieldTimeline = exports.SingleTimelineResponseType = exports.SavedTimelineRuntimeType = exports.RowRendererIdRuntimeType = exports.RowRendererId = exports.ResolvedTimelineSavedObjectToReturnObjectRuntimeType = exports.ResolvedSingleTimelineResponseType = exports.DataProviderTypeLiteralRt = exports.DataProviderType = exports.AllTimelineSavedObjectRuntimeType = void 0;
...
(function (TimelineId) {
  TimelineId["usersPageEvents"] = "users-page-events";
  TimelineId["usersPageExternalAlerts"] = "users-page-external-alerts";
  TimelineId["hostsPageEvents"] = "hosts-page-events";
  TimelineId["hostsPageExternalAlerts"] = "hosts-page-external-alerts";
  TimelineId["hostsPageSessions"] = "hosts-page-sessions-v2";
  ...
  TimelineId["rulePreview"] = "rule-preview";
})(TimelineId || (exports.TimelineId = TimelineId = {}));

const TimelineIdLiteralRt = runtimeTypes.union([runtimeTypes.literal(TimelineId.usersPageEvents), runtimeTypes.literal(TimelineId.usersPageExternalAlerts), runtimeTypes.literal(TimelineId.hostsPageEvents), runtimeTypes.literal(TimelineId.hostsPageExternalAlerts), runtimeTypes.literal(TimelineId.hostsPageSessions), runtimeTypes.literal(TimelineId.detectionsRulesDetailsPage), runtimeTypes.literal(TimelineId.detectionsPage), runtimeTypes.literal(TimelineId.networkPageExternalAlerts), runtimeTypes.literal(TimelineId.active), runtimeTypes.literal(TimelineId.test), runtimeTypes.literal(TimelineId.rulePreview)]);
...
const ResolvedTimelineSavedObjectToReturnObjectRuntimeType = runtimeTypes.intersection([runtimeTypes.type({
  ...
  alias_purpose: _schemas.alias_purpose
})]);
