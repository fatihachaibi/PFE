...
const TIMESTAMP_FIELD = '@timestamp'; // Platform fields
...
const TOTAL_ACTIONS_TRIGGERED_FIELD = 'kibana.alert.rule.execution.metrics.number_of_triggered_actions'; // TODO: To be added in https://github.com/elastic/kibana/pull/126210
...
const SORT_FIELD_TO_AGG_MAPPING = {
  ...
  num_triggered_actions: 'ruleExecution>numTriggeredActions' // TODO: To be added in https://github.com/elastic/kibana/pull/126210
...
const mapRuleExecutionStatusToPlatformStatus = ruleStatuses => {
  return (0, _lodash.flatMap)(ruleStatuses, rs => {
    switch (rs) {
      case _common.RuleExecutionStatus.failed:
        return 'failure';

      case _common.RuleExecutionStatus.succeeded:
        return 'success';
...
const mapPlatformStatusToRuleExecutionStatus = platformStatus => {
  switch (platformStatus) {
    case 'failure':
      return _common.RuleExecutionStatus.failed;

    case 'success':
      return _common.RuleExecutionStatus.succeeded;
