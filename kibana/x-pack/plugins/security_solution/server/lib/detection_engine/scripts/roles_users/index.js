...
var _hunter_no_actions = require("./hunter_no_actions");

Object.keys(_hunter_no_actions).forEach(function (key) {
  if (key === "default" || key === "__esModule") return;
  if (key in exports && exports[key] === _hunter_no_actions[key]) return;
  Object.defineProperty(exports, key, {
    enumerable: true,
    get: function () {
      return _hunter_no_actions[key];
    }
  });
});
