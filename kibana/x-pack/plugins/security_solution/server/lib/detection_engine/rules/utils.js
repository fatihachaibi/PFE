...
exports.transformToNotifyWhen = exports.transformToAlertThrottle = exports.transformFromAlertThrottle = exports.transformActions = exports.removeUndefined = exports.maybeMute = exports.legacyMigrate = exports.getUpdatedActionsParams = exports.calculateVersion = exports.calculateName = exports.calculateInterval = void 0;
...
const legacyMigrate = async ({
  ...
  const legacyRuleNotificationSOsExist = legacyRuleActionsSO != null && legacyRuleActionsSO.saved_objects.length > 0; // Assumption: if no legacy sidecar SO or notification rule types exist
  ...
  if (legacyRuleNotificationSOsExist) {
    ...
    await savedObjectsClient.delete(_legacy_saved_object_mappings.legacyRuleActionsSavedObjectType, legacyRuleActionsSO.saved_objects[0].id); // If "siem-detection-engine-rule-actions" notes that `ruleThrottle` is
