...
var _privilege_escalation_linux_strace_activity = _interopRequireDefault(require("./privilege_escalation_linux_strace_activity.json"));
...
var _privilege_escalation_gcp_kubernetes_rolebindings_created_or_patched = _interopRequireDefault(require("./privilege_escalation_gcp_kubernetes_rolebindings_created_or_patched.json"));

var _ml_auth_rare_hour_for_a_user_to_logon = _interopRequireDefault(require("./ml_auth_rare_hour_for_a_user_to_logon.json"));

var _ml_auth_rare_source_ip_for_a_user = _interopRequireDefault(require("./ml_auth_rare_source_ip_for_a_user.json"));

var _ml_auth_rare_user_logon = _interopRequireDefault(require("./ml_auth_rare_user_logon.json"));

var _ml_auth_spike_in_failed_logon_events = _interopRequireDefault(require("./ml_auth_spike_in_failed_logon_events.json"));

var _ml_auth_spike_in_logon_events = _interopRequireDefault(require("./ml_auth_spike_in_logon_events.json"));

var _ml_auth_spike_in_logon_events_from_a_source_ip = _interopRequireDefault(require("./ml_auth_spike_in_logon_events_from_a_source_ip.json"));
...
var _defense_evasion_whitespace_padding_in_command_line = _interopRequireDefault(require("./defense_evasion_whitespace_padding_in_command_line.json"));
...
var _privilege_escalation_krbrelayup_suspicious_logon = _interopRequireDefault(require("./privilege_escalation_krbrelayup_suspicious_logon.json"));
