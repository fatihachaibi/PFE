...
const buildBulkBody = (spaceId, completeRule, doc, mergeStrategy, ignoreFields, applyOverrides, buildReasonMessage) => {
  ...
  if (isSourceDoc(mergedDoc)) {
    return { ...filteredSource,
      ...eventFields,
      ...(0, _build_alert.buildAlert)([mergedDoc], completeRule, spaceId, reason, overrides),
      ...(0, _build_alert.additionalAlertFields)({ ...mergedDoc,
        _source: { ...mergedDoc._source,
          ...eventFields
        }
      })
    };
