...
exports.createPrepackagedRules = exports.addPrepackedRulesRoute = exports.PrepackagedRulesError = void 0;
...
const createPrepackagedRules = async (context, rulesClient, exceptionsClient) => {
  ...
  await Promise.all((0, _install_prepacked_rules.installPrepackagedRules)(rulesClient, rulesToInstall, signalsIndex));
  ...
  await (0, _update_prepacked_rules.updatePrepackagedRules)(rulesClient, savedObjectsClient, rulesToUpdate, signalsIndex, context.getRuleExecutionLog());
