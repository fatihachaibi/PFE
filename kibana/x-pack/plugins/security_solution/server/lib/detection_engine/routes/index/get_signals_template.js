...
const baseProps = { ..._signal_extra_fields.default,
  ...createSignalsFieldAliases()
};
const properties = { ...baseProps,
  signal: { ...baseProps.signal,
    properties: { ...baseProps.signal.properties,
      rule: { ...baseProps.signal.properties.rule,
        properties: { ...baseProps.signal.properties.rule.properties,
          building_block_type: {
            type: 'keyword'
          }
        }
