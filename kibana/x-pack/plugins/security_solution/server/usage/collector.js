...
var _get_metrics = require("./detections/get_metrics");

var _get_internal_saved_objects_client = require("./get_internal_saved_objects_client");
/*
...
const registerCollector = ({
  ...
  const collector = usageCollection.makeUsageCollector({
    ...
    fetch: async ({
      ...
      const detectionMetrics = await (0, _get_metrics.getDetectionsMetrics)({
        eventLogIndex,
        signalsIndex,
        esClient,
        savedObjectsClient,
