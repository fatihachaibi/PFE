...
const transformEventLogTypeStatus = ({
  ...
  const thresholdMetrics = aggs.eventActionExecutionMetrics['siem.thresholdRule']; // failure status
  ...
  const thresholdFailure = aggs.eventActionStatusChange.failed['siem.thresholdRule']; // partial failure
  ...
  const thresholdPartialFailure = aggs.eventActionStatusChange['partial failure']['siem.thresholdRule']; // success
