...
class RequestContextFactory {
  ...
  async create(context, request) {
    ...
    let endpointAuthz;
    let fleetAuthz; // If Fleet is enabled, then get its Authz
    ...
    return {
      ...
      get endpointAuthz() {
        ...
        if (!endpointAuthz) {
          ...
          if (!startPlugins.fleet) {
            ...
            endpointAuthz = (0, _authz.calculateEndpointAuthz)(_license.licenseService, fleetAuthz, userRoles);
          }
        }
      ...
      getRuleExecutionLog: (0, _lodash.memoize)(() => (0, _rule_execution_log.ruleExecutionLogForRoutesFactory)(coreContext.savedObjects.client, startPlugins.eventLog.getClient(request), logger)),
