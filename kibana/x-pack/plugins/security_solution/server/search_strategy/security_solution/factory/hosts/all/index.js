...
const allHosts = {
  ...
  parse: async (options, response, deps) => {
    ...
    const enhancedEdges = deps !== null && deps !== void 0 && deps.spaceId && deps !== null && deps !== void 0 && deps.endpointContext.experimentalFeatures.riskyHostsEnabled ? await enhanceEdges(edges, hostNames, deps.spaceId, deps.esClient) : edges;
    return { ...response,
      inspect,
      edges: enhancedEdges,
      totalCount,
...
async function enhanceEdges(edges, hostNames, spaceId, esClient) {
  ...
  const hostsRiskByHostName = hostRiskData === null || hostRiskData === void 0 ? void 0 : hostRiskData.hits.hits.reduce((acc, hit) => {
    var _hit$_source$host$nam, _hit$_source, _hit$_source2;

    return { ...acc,
      [(_hit$_source$host$nam = (_hit$_source = hit._source) === null || _hit$_source === void 0 ? void 0 : _hit$_source.host.name) !== null && _hit$_source$host$nam !== void 0 ? _hit$_source$host$nam : '']: (_hit$_source2 = hit._source) === null || _hit$_source2 === void 0 ? void 0 : _hit$_source2.risk
    };
  }, {});
