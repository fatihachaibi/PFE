...
var _rule_execution_log = require("./lib/detection_engine/rule_execution_log");
...
class Plugin {
  ...
  setup(core, plugins) {
    var _plugins$usageCollect, _plugins$encryptedSav;
    ...
    (0, _rule_execution_log.registerEventLogProvider)(eventLogService);
    ...
    let previewRuleDataClient = null; // rule options are used both to create and preview rules.
    ...
    const ruleDataServiceOptions = {
      ...
      componentTemplates: [{
        name: 'mappings',
        mappings: (0, _mapping_from_field_map.mappingFromFieldMap)({ ..._technical_rule_field_map.technicalRuleFieldMap,
    ...
    const securityRuleTypeOptions = {
      ...
      ruleDataClient,
      eventLogService,
      ruleExecutionLoggerFactory: _rule_execution_log.ruleExecutionLogForExecutorsFactory
    };
    ...
    plugins.alerting.registerType(securityRuleTypeWrapper((0, _rule_types.createSavedQueryAlertType)(ruleOptions)));
    ...
    plugins.alerting.registerType(securityRuleTypeWrapper((0, _rule_types.createQueryAlertType)(ruleOptions)));
    plugins.alerting.registerType(securityRuleTypeWrapper((0, _rule_types.createThresholdAlertType)(ruleOptions))); // TODO We need to get the endpoint routes inside of initRoutes
    ...
    const ruleTypes = [_constants.LEGACY_NOTIFICATIONS_ID, _securitysolutionRules.EQL_RULE_TYPE_ID, _securitysolutionRules.INDICATOR_RULE_TYPE_ID, _securitysolutionRules.ML_RULE_TYPE_ID, _securitysolutionRules.QUERY_RULE_TYPE_ID, _securitysolutionRules.SAVED_QUERY_RULE_TYPE_ID, _securitysolutionRules.THRESHOLD_RULE_TYPE_ID];
    plugins.features.registerKibanaFeature((0, _features.getKibanaPrivilegesFeaturePrivileges)(ruleTypes));
    ...
    core.getStartServices().then(([_, depsStart]) => {
      ...
      const securitySolutionSearchStrategy = (0, _security_solution.securitySolutionSearchStrategyProvider)(depsStart.data, endpointContext, (_depsStart$spaces2 = depsStart.spaces) === null || _depsStart$spaces2 === void 0 ? void 0 : (_depsStart$spaces2$sp = _depsStart$spaces2.spacesService) === null || _depsStart$spaces2$sp === void 0 ? void 0 : _depsStart$spaces2$sp.getSpaceId);
  ...
  start(core, plugins) {
    ...
    const registerIngestCallback = (_plugins$fleet = plugins.fleet) === null || _plugins$fleet === void 0 ? void 0 : _plugins$fleet.registerExternalCallback; // eslint-disable-next-line @typescript-eslint/no-non-null-assertion

    const exceptionListClient = this.lists.getExceptionListClient(savedObjectsClient, 'kibana', // execution of Lists plugin server extension points callbacks should be turned off
    ...
    this.telemetryReceiver.start(core, // eslint-disable-next-line @typescript-eslint/no-non-null-assertion
