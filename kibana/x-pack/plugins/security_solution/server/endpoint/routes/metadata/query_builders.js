...
exports.getPagingProperties = getPagingProperties;
...
const IGNORED_ELASTIC_AGENT_IDS = ['00000000-0000-0000-0000-000000000000', '11111111-1111-1111-1111-111111111111']; // sort using either event.created, or HostDetails.event.created,
...
request, endpointAppContext) {
  ...
  return {
    pageSize: pagingProperties.page_size || _constants.ENDPOINT_DEFAULT_PAGE_SIZE,
    pageIndex: pagingProperties.page_index || _constants.ENDPOINT_DEFAULT_PAGE
  };
}
