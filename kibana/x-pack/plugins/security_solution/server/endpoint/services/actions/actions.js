...
const getPendingActionCounts = async (esClient, metadataService, agentIDs, isPendingActionResponsesWithAckEnabled) => {
  ...
  .then(result => {
    ...
    return (result === null || result === void 0 ? void 0 : (_result$hits = result.hits) === null || _result$hits === void 0 ? void 0 : (_result$hits$hits = _result$hits.hits) === null || _result$hits$hits === void 0 ? void 0 : _result$hits$hits.map(a => a._source)) || [];
...
const hasEndpointResponseDoc = async ({
  ...
  const response = await esClient.search({
    ...
    var _result$hits2, _result$hits2$hits;

    return (result === null || result === void 0 ? void 0 : (_result$hits2 = result.hits) === null || _result$hits2 === void 0 ? void 0 : (_result$hits2$hits = _result$hits2.hits) === null || _result$hits2$hits === void 0 ? void 0 : _result$hits2$hits.map(a => {
      var _a$_source;
...
const fetchActionResponses = async (esClient, metadataService, actionIds, agentIds) => {
  ...
  .then(result => {
    var _result$hits3, _result$hits3$hits;

    return (result === null || result === void 0 ? void 0 : (_result$hits3 = result.hits) === null || _result$hits3 === void 0 ? void 0 : (_result$hits3$hits = _result$hits3.hits) === null || _result$hits3$hits === void 0 ? void 0 : _result$hits3$hits.map(a => a._source)) || [];
  }).catch(_utils.catchAndWrapError);
