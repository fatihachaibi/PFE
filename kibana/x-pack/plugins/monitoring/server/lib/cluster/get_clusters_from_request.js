...
async function getClustersFromRequest(req, indexPatterns, {
  ...
  const kibanas = (0, _is_in_code_path.isInCodePath)(codePaths, [_constants.CODE_PATH_KIBANA]) && !isStandaloneCluster ? await (0, _kibana.getKibanasForClusters)(req, clusters, _constants.CCS_REMOTE_PATTERN) : []; // add the kibana data to each cluster
