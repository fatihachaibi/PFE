...
function logstashPipelineRoute(server) {
  ...
  server.route({
    ...
    async handler(req) {
      ...
      const pipelineHash = (_req$params$pipelineH = req.params.pipelineHash) !== null && _req$params$pipelineH !== void 0 ? _req$params$pipelineH : null; // Figure out which version of the pipeline we want to show
