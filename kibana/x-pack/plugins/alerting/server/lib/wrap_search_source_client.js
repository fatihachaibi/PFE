...
function wrapSearchSourceClient({
  ...
  wrappedSearchSourceClient.createEmpty = () => {
    ...
    return wrapSearchSource({ ...wrapParams,
      pureSearchSource
    });
  };
...
function wrapSearchSource({
  ...
  wrappedSearchSource.createChild = wrapCreateChild({ ...wrapParams,
    pureSearchSource
  });
  wrappedSearchSource.createCopy = wrapCreateCopy({ ...wrapParams,
    pureSearchSource
  });
  wrappedSearchSource.create = wrapCreate({ ...wrapParams,
    pureSearchSource
  });
  wrappedSearchSource.fetch$ = wrapFetch$({ ...wrapParams,
    pureSearchSource
  });
...
function wrapFetch$({
  ...
  return options => {
    ...
    return pureSearchSource.fetch$({ ...searchOptions,
