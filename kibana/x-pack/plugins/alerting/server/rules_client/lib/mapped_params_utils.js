...
const modifyFilterKueryNode = ({
  ...
  const action = ({
    ...
    if (index === 0) {
      const firstAttribute = (0, _validate_attributes.getFieldNameAttribute)(fieldName, ['alert', 'attributes']); // Replace the ast.value for params to mapped_params
      ...
      const firstAttribute = (0, _validate_attributes.getFieldNameAttribute)(localFieldName, ['alert', 'attributes']); // Replace the ast.value for params value to the modified mapped_params value
