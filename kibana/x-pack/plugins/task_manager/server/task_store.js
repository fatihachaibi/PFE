...
class TaskStore {
  ...
  async search(opts = {}) {
    ...
    try {
      ...
      return {
        docs: tasks // @ts-expect-error @elastic/elasticsearch _source is optional
        .filter(doc => this.serializer.isRawSavedObject(doc)) // @ts-expect-error @elastic/elasticsearch _source is optional
