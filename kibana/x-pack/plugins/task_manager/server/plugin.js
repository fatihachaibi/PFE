...
class TaskManagerPlugin {
  ...
  setup(core, plugins) {
    ...
    this.usageCounter = (_plugins$usageCollect = plugins.usageCollection) === null || _plugins$usageCollect === void 0 ? void 0 : _plugins$usageCollect.createUsageCounter(`taskManager`); // Routes
