...
var _constants = require("./alert_types/es_query/constants");
...
const BUILT_IN_ALERTS_FEATURE = {
  ...
  alerting: [_alert_type.ID, _alert_type2.GEO_CONTAINMENT_ID, _constants.ES_QUERY_ID, TransformHealth],
  privileges: {
    all: {
      app: [],
      catalogue: [],
      ...
      alerting: {
        rule: {
          all: [_alert_type.ID, _alert_type2.GEO_CONTAINMENT_ID, _constants.ES_QUERY_ID, TransformHealth]
        },
        alert: {
          all: [_alert_type.ID, _alert_type2.GEO_CONTAINMENT_ID, _constants.ES_QUERY_ID, TransformHealth]
        }
    ...
    read: {
      ...
      alerting: {
        rule: {
          read: [_alert_type.ID, _alert_type2.GEO_CONTAINMENT_ID, _constants.ES_QUERY_ID, TransformHealth]
        },
        alert: {
          read: [_alert_type.ID, _alert_type2.GEO_CONTAINMENT_ID, _constants.ES_QUERY_ID, TransformHealth]
        }
