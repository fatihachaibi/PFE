...
function setupEmbeddable(embeddable, getFilterMigrations) {
  embeddable.registerEmbeddableFactory({
    id: _constants.MAP_SAVED_OBJECT_TYPE,
    migrations: () => {
      return (0, _common.mergeMigrationFunctionMaps)(_embeddable_migrations.embeddableMigrations, (0, _saved_objects.getPersistedStateMigrations)(getFilterMigrations()));
    },
