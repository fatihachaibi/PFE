...
exports.getPersistedStateMigrations = void 0;
...
function setupSavedObjects(core, getFilterMigrations) {
  core.savedObjects.registerType({
    ...
    migrations: () => {
      return (0, _server.mergeSavedObjectMigrationMaps)(_saved_object_migrations.savedObjectMigrations, getPersistedStateMigrations(getFilterMigrations()));
    }
  });
  /*
...
const getPersistedStateMigrations = filterMigrations => (0, _lodash.mapValues)(filterMigrations, filterMigration => doc => {
  try {
...
exports.getPersistedStateMigrations = getPersistedStateMigrations;