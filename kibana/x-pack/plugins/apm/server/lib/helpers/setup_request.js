...
async function setupRequest({
  ...
  return (0, _with_apm_span.withApmSpan)('setup_request', async () => {
    ...
    return {
      ...
      internalClient: await (0, _create_internal_es_client.createInternalESClient)({
        context,
        request,
        debug: query._inspect
      }),
      ml: plugins.ml && (0, _license_check.isActivePlatinumLicense)(licensingContext.license) ? getMlSetup(plugins.ml.setup, coreContext.savedObjects.client, request) : undefined,
      config
    };
  });
}
