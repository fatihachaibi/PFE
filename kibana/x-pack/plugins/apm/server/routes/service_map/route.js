...
const serviceMapRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  handler: async resources => {
    ...
    const serviceNames = [...(serviceName ? [serviceName] : []), ...((_serviceGroup$service = serviceGroup === null || serviceGroup === void 0 ? void 0 : serviceGroup.serviceNames) !== null && _serviceGroup$service !== void 0 ? _serviceGroup$service : [])];
