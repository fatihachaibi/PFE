...
async function getServicesData(options) {
  ...
  const params = {
    ...
    body: {
      ...
      query: {
        bool: {
          filter: [...(0, _server.rangeQuery)(start, end), ...(0, _environment_query.environmentQuery)(environment), ...(0, _server.termsQuery)(_elasticsearch_fieldnames.SERVICE_NAME, ...((_options$serviceNames = options.serviceNames) !== null && _options$serviceNames !== void 0 ? _options$serviceNames : []))]
        }
      },
      aggs: {
        services: {
