...
const fetchTransactionDurationPercentiles = async (esClient, params, percents, termFilters) => {
  ...
  return {
    totalDocs: resp.hits.total.value,
    percentiles: (_resp$aggregations$tr = resp.aggregations.transaction_duration_percentiles.values) !== null && _resp$aggregations$tr !== void 0 ? _resp$aggregations$tr : {}
  };
};
