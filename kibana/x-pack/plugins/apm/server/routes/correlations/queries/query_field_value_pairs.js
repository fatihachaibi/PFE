...
const fetchTransactionDurationFieldTerms = async (esClient, params, fieldName) => {
  ...
  const buckets = (_resp$aggregations$at = resp.aggregations.attribute_terms) === null || _resp$aggregations$at === void 0 ? void 0 : _resp$aggregations$at.buckets;
