...
function registerTransactionDurationAlertType({
  ...
  const type = createLifecycleRuleType({
    ...
    actionVariables: {
      context: [_action_variables.apmActionVariables.serviceName, _action_variables.apmActionVariables.transactionType, _action_variables.apmActionVariables.environment, _action_variables.apmActionVariables.threshold, _action_variables.apmActionVariables.triggerValue, _action_variables.apmActionVariables.interval, _action_variables.apmActionVariables.reason, _action_variables.apmActionVariables.viewInAppUrl]
    },
    ...
    executor: async ({
      ...
      if (transactionDuration && transactionDuration > thresholdMicroseconds) {
        ...
        const reasonMessage = (0, _alert_types.formatTransactionDurationReason)({
        ...
        const relativeViewInAppUrl = (0, _formatters2.getAlertUrlTransaction)(ruleParams.serviceName, (_getEnvironmentEsFiel = (0, _environment_filter_values.getEnvironmentEsField)(ruleParams.environment)) === null || _getEnvironmentEsFiel === void 0 ? void 0 : _getEnvironmentEsFiel[_elasticsearch_fieldnames.SERVICE_ENVIRONMENT], ruleParams.transactionType);
