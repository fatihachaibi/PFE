...
const debugTelemetryRoute = (0, _create_apm_server_route.createApmServerRoute)({
  ...
  handler: async resources => {
    ...
    await (taskManagerStart === null || taskManagerStart === void 0 ? void 0 : (_taskManagerStart$run = taskManagerStart.runNow) === null || _taskManagerStart$run === void 0 ? void 0 : _taskManagerStart$run.call(taskManagerStart, _apm_telemetry.APM_TELEMETRY_TASK_NAME));
