...
const getDynamicDataView = ({
  ...
  return (0, _with_apm_span.withApmSpan)('get_dynamic_data_view', async () => {
    ...
    const DataViewsFetcher = new _server.IndexPatternsFetcher(coreContext.elasticsearch.client.asCurrentUser); // Since `getDynamicDataView` is called in setup_request (and thus by every endpoint)
