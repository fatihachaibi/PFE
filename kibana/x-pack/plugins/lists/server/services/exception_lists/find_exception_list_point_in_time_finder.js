...
exports.findExceptionListPointInTimeFinder = void 0;
...
const findExceptionListPointInTimeFinder = async ({
  namespaceType,
  savedObjectsClient,
  executeFunctionOnStream,
  maxSize,
  ...
  for await (const savedObjectsFindResponse of finder.find()) {
    ...
    const exceptionList = (0, _utils.transformSavedObjectsToFoundExceptionList)({
...
exports.findExceptionListPointInTimeFinder = findExceptionListPointInTimeFinder;