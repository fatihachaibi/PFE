...
class AlertsClient {
  constructor(options) {
    ...
    this.auditLogger = options.auditLogger; // If spaceId is undefined, it means that spaces is disabled
  ...
  async update({
    ...
    try {
      ...
      const response = await this.esClient.update({ ...(0, _securitysolutionEsUtils.decodeVersion)(_version),
        id,
        index,
        body: {
          doc: { ...fieldToUpdate
  ...
  async getAuthorizedAlertsIndices(featureIds) {
    try {
      ...
      const toReturn = validAuthorizedFeatures.map(feature => {
        ...
        return (_index$getPrimaryAlia = index === null || index === void 0 ? void 0 : index.getPrimaryAlias((_this$spaceId = this.spaceId) !== null && _this$spaceId !== void 0 ? _this$spaceId : '*')) !== null && _index$getPrimaryAlia !== void 0 ? _index$getPrimaryAlia : '';
      });
      return toReturn;
    } catch (exc) {
