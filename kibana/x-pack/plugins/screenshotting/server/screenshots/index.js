...
class Screenshots {
  constructor(browserDriverFactory, logger, packageInfo, http, config, cloud) {
    ...
    this.config = config;
    this.cloud = cloud;
    this.semaphore = new _semaphore.Semaphore(config.poolSize);
  }
  ...
  captureScreenshots(eventLogger, layout, options) {
    ...
    return this.browserDriverFactory.createPage({
      ...
      }), (0, _operators.takeUntil)(unexpectedExit$), screen.getScreenshots())), (0, _operators.take)(options.urls.length), (0, _operators.toArray)(), (0, _operators.mergeMap)(results => // At this point we no longer need the page, close it and send out the results
  ...
  getCaptureOptions({
    ...
    const headers = { ...((_request$headers = request === null || request === void 0 ? void 0 : request.headers) !== null && _request$headers !== void 0 ? _request$headers : {}),
    ...
    return (0, _lodash.defaultsDeep)({ ...options,
      headers,
      urls
    }, {
      timeouts: {
