...
const initSavedQueryRoutes = (router, context) => {
  ...
  (0, _delete_saved_query_route.deleteSavedQueryRoute)(router, context);
  (0, _find_saved_query_route.findSavedQueryRoute)(router, context);
  (0, _read_saved_query_route.readSavedQueryRoute)(router, context);
