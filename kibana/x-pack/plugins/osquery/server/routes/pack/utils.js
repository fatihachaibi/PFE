...
const convertSOQueriesToPack = (queries, options) => (0, _lodash.reduce)(queries, // eslint-disable-next-line @typescript-eslint/naming-convention
(acc, {
  id: queryId,
  ecs_mapping,
  query,
  ...
  acc[index] = { ...rest,
    query: options !== null && options !== void 0 && options.removeMultiLines ? (0, _remove_multilines.removeMultilines)(query) : query,
