...
class PackagePolicyService {
  async create(soClient, esClient, packagePolicy, options) {
    ...
    if (agentPolicy && ((_packagePolicy$packag = packagePolicy.package) === null || _packagePolicy$packag === void 0 ? void 0 : _packagePolicy$packag.name) === _common.FLEET_APM_PACKAGE) {
      const dataOutput = await (0, _agent_policies.getDataOutputForAgentPolicy)(soClient, agentPolicy);

      if (dataOutput.type === _common.outputType.Logstash) {
        throw new _errors.IngestManagerError('You cannot add APM to a policy using a logstash output');
      }
  ...
  async delete(soClient, esClient, ids, options) {
    ...
    for (const id of ids) {
      try {
        var _packagePolicy$packag4, _packagePolicy$packag5, _packagePolicy$packag6;
        ...
        result.push({
          ...
          success: true,
          package: {
            name: ((_packagePolicy$packag4 = packagePolicy.package) === null || _packagePolicy$packag4 === void 0 ? void 0 : _packagePolicy$packag4.name) || '',
            title: ((_packagePolicy$packag5 = packagePolicy.package) === null || _packagePolicy$packag5 === void 0 ? void 0 : _packagePolicy$packag5.title) || '',
            version: ((_packagePolicy$packag6 = packagePolicy.package) === null || _packagePolicy$packag6 === void 0 ? void 0 : _packagePolicy$packag6.version) || ''
          },
  ...
  validateUpgradePackagePolicy(id, packageInfo, packagePolicy) {
    var _packagePolicy$packag7, _packageInfo$version;
    ...
    if (!((_packagePolicy$packag7 = packagePolicy.package) !== null && _packagePolicy$packag7 !== void 0 && _packagePolicy$packag7.name)) {
  ...
  async doUpgrade(soClient, esClient, id, packagePolicy, result, packageInfo, options) {
