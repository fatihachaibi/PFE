...
const installTransform = async (installablePackage, paths, esClient, savedObjectsClient, logger, esReferences) => {
  ...
  if (transformPaths.length > 0) {
    ...
    esReferences = await (0, _install.updateEsAssetReferences)(savedObjectsClient, installablePackage.name, esReferences, {
