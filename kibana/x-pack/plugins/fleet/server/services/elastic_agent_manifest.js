...
exports.elasticAgentStandaloneManifest = exports.elasticAgentManagedManifest = void 0;
/*
...
const elasticAgentStandaloneManifest = `---
apiVersion: apps/v1
kind: DaemonSet
metadata:
  name: elastic-agent
...
---
`;
exports.elasticAgentStandaloneManifest = elasticAgentStandaloneManifest;
const elasticAgentManagedManifest = `---
apiVersion: apps/v1
kind: DaemonSet
metadata:
  name: elastic-agent
...
---
`;
exports.elasticAgentManagedManifest = elasticAgentManagedManifest;