...
const registerRoutes = router => {
  ...
  }, _handlers.downloadFullAgentPolicy); // Get agent manifest

  router.get({
    path: _common.K8S_API_ROUTES.K8S_INFO_PATTERN,
  ...
  }, _handlers.getK8sManifest); // Download agent manifest

  router.get({
    path: _common.K8S_API_ROUTES.K8S_DOWNLOAD_PATTERN,
    validate: _types.GetK8sManifestRequestSchema,
    fleetAuthz: {
      fleet: {
        all: true
