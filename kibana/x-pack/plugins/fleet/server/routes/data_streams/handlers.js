...
var _get_metadata_from_terms_enum = require("./get_metadata_from_terms_enum");

var _get_metadata_from_aggregations = require("./get_metadata_from_aggregations");
/*
  ...
  try {
    ...
    const dataStreamPromises = dataStreamNames.map(async dataStreamName => {
      ...
      const {
        ...
        serviceNames,
        environments
      } = useTermsEnum ? await (0, _get_metadata_from_terms_enum.getMetadataFromTermsEnum)({
        dataStreamName: dataStream.name,
        esClient
      }) : await (0, _get_metadata_from_aggregations.getMetadataFromAggregations)({
        dataStreamName: dataStream.name,
        esClient
      ...
      dataStreamResponse.type = type; // Find package saved object
