...
const registerAPIRoutes = (router, config) => {
  ...
  }, _handlers.getAgentStatusForAgentPolicyHandler); // Agent data
  ...
  }, _handlers.getAgentDataHandler); // upgrade agent
  ...
  }, _upgrade_handler.postBulkAgentsUpgradeHandler); // Current upgrades
  ...
  }, _upgrade_handler.getCurrentUpgradesHandler); // Bulk reassign
