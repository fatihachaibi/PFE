...
exports.updateAgentHandler = exports.putAgentsReassignHandler = exports.postBulkAgentsReassignHandler = exports.getAgentsHandler = exports.getAgentStatusForAgentPolicyHandler = exports.getAgentHandler = exports.getAgentDataHandler = exports.deleteAgentHandler = void 0;
...
const postBulkAgentsReassignHandler = async (context, request, response) => {
  ...
  try {
    const results = await AgentService.reassignAgents(soClient, esClient, { ...agentOptions,
